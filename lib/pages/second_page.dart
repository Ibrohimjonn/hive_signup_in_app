...
import 'package:wallpaper_demo/model/user_model.dart';
import 'package:wallpaper_demo/pages/first_page.dart';
import 'package:wallpaper_demo/service/hide_service.dart';
                        ...
                        child:Row(
                          ...
                          children: [
                            ...
                            GestureDetector(
                                ...
                                onTap:()async{
                                  await Navigator.pushReplacementNamed(context, FirstPage.id);
                                }
                            ),
                          ],
                        ),
